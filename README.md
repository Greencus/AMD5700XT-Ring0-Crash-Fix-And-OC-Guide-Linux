...
- Replace the GRUB_CMDLINE_LINUX_DEFAULT line in /etc/default/grub with: `GRUB_CMDLINE_LINUX_DEFAULT='quiet splash amdgpu.noretry=0 amdgpu.lockup_timeout=-1 amdgpu.gpu_recovery=1 amdgpu.ppfeaturemask=0xf7fff amdgpu.runpm=0 amdgpu.mcbp=0 iommu=pt pcie_aspm=off'`
